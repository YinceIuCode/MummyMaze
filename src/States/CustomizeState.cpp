...
void CustomizeState::initGui() {
    ...
    // Set sound (nếu Button class đã hỗ trợ check mute)
...
// --- HÀM QUAN TRỌNG NHẤT: TỰ ĐỘNG GHÉP ĐƯỜNG DẪN ---
void CustomizeState::loadThemePreview(int index) {
    ...
    // 1. Ghép chuỗi để load Player: "basePath + player.png"
    ...
    // 2. Ghép chuỗi để load Mummy: "basePath + mummy.png"
